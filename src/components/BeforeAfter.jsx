...
const BeforeAfter = () => {
  ...
  return (
    <section id="before-after" className="before-after section-padding bg-darker">
      <div className="container container-sm text-center margin-bottom">
        <h2 className="section-title">Raw vs <span className="text-neon-blue text-glow">Edited</span></h2>
        <p className="section-subtitle">Drag the slider to see the magic of advanced color grading.</p>
      </div>
      ...
      <div className="container">
        ...
        >
          ...
          <div className="ba-image edited" style={{ width: `${sliderPos}%` }}>
